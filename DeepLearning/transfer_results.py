...
local_destinations = os.path.join(local_destinations, "ResNet_Folds_debug24")
local_destinations = [f"{local_destinations}" for i in [5]]
subfolders = [f"Regression/ResNet_Folds_debug24/fold{i}" for i in [5]]
