...
local_destinations = os.path.join(local_destinations, "ResNet_Folds_debug18")
local_destinations = [f"{local_destinations}" for i in [1,2,3,4, 5, 6, 7, 8]]
subfolders = [f"Regression/ResNet_Folds_debug18/fold{i}" for i in [1,2,3,4, 5, 6, 7, 8]]
